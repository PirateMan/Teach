$(document).ready(function () {
    ...
    $('#training').Tabledit({
        ...
        columns: {
            identifier: [0, 'id'],
            editable: [[1, 'demoBy'], [2, 'demoOn'], [3, 'dateCompleted']],
        }
    });
    ...
    for (var x = 1; x < tableRowLength; x++) {
        var test = table.rows[x].cells[6].children[0].id = x;
    }

    for (var x = 1; x < tableRowLength; x++) {
        if (table.rows[x].cells[5].innerText.indexOf("Approved By") !== -1) {
            var rowId = table.rows[x].cells[6].children[0].id;
    ...
    $('.tabledit-edit-button').click(function () {
        ...
        var input3 = table.rows[rowIndex].cells[3].children[1].value;
        ...
        $(".tabledit-input").on("keyup change input", function () {
            ...
            if (input1 != "" && input2 != "" && input3 != "") {
                ...
                if (input2.length > 9 && input2.match(/^\d+$/)) {
    ...
    $('.tabledit-save-button').click(function () {
        ...
        var input5 = table.rows[rowIndex].cells[5].innerText;

        if (input1 != "" && input2 != "" && input3 != "") {
            table.rows[rowIndex].cells[4].innerText = "Completed";
            table.rows[rowIndex].cells[5].innerText = "Awaiting Approval";
            input4 = table.rows[rowIndex].cells[4].innerText;
            input5 = table.rows[rowIndex].cells[5].innerText;
        }

        PageMethods.sqlInsertThree(input0, input1, input2, input3, input4, input5);
