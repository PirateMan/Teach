            ...
            columns: {
                ...
                toolbar: function() {
                    if (settings.editButton || settings.deleteButton) {
                        ...
                        var trGt = $table.find('tr:gt(0)'); trGt.each(function () { var addEditvalues = $(this).children("#edit").length === 0; if (addEditvalues) { // Add toolbar column cells. $(this).append('<td id="edit" style="white-space: nowrap; width: 1%;">' + toolbar + '</td>'); } });
