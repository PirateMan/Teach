...
public partial class SignOffCaseNumberMainMaster : System.Web.UI.MasterPage
{
    ...
    public void fillTable()
    {
        ...
        using (serverBUEntitiesConnection db = new serverBUEntitiesConnection())
        {
            ...
            var repeaterDataSource = db.TrainingPackage_SignOffCaseNumber_Table(userID, taskName);
