<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ViewTargets.aspx.cs" Inherits="MemberPages_ViewTargets" %>
...
<body>
    ...
    <form id="form1" runat="server">
        ...
        <div class="container-fluid" id="topBar">
            <div class="col-md-6" id="titleText"><p><b id="trainingPackageText"><a href="Home.aspx">Training Package</a></b> | Mentor | Targets</p></div>
        ...
        <div class="container" id="tableContainer" runat="server">
            ...
            <div id="repeaterTableWrapper" style="width: 100%">
                ...
                <asp:Repeater ID="Repeater1" runat="server">
                    ...
                    <ItemTemplate>
                        ...
                        <tr id="calculationTableUser" runat="server">
                            <td><asp:Label runat="server" ID="targetLabel" Text='<%#Eval("target")%>'/></td>
                            <td class="myDate"><asp:Label runat="server" ID="dateLabel" Text='<%#Eval("targetDate")%>'/></td>
                            <td><asp:Label runat="server" ID="descriptionLabel" Text='<%#Eval("targetDescription")%>'/></td>
                            <td><asp:Label runat="server" ID="createdByLabel" Text='<%#Eval("targetCreatedBy")%>'/></td>
                            <td><asp:Label runat="server" ID="completedLabel" Text='<%#Eval("targetCompleted")%>'/></td>
                        </tr>
