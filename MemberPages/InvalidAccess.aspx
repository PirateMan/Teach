<%@ Page Language="C#" AutoEventWireup="true" Codefile="InvalidAccess.aspx.cs" Inherits="TrainingApp.InvalidAccess" %>
...
<form id="form1" runat="server">
        ...
        <div class="container-fluid" id="topBar">
            <div class="col-md-8" id="titleText">
                <p><b id="trainingPackageText"><a href="Home.aspx">Training Package</a></b> | Invalid Access</p>
            </div>
